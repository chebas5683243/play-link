...
const roleIconMap = {
  ...
  [MemberRole.MODERATOR]: <ShieldCheck className="size-4" />,
...
export function ServerMember({ member, server }: ServerMemberProps) {
  ...
  return (
    <button
      onClick={() => {}}
      className={cn(
        "group px-2 py-4 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1",
